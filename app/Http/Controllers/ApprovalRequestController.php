...
class ApprovalRequestController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.approval_request.show')->with('diary',$diary_details);
    }
    ...
    public function print($id)
    {
        ...
        return view('admin.approval_request.print')->with('diary',$diary_details);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        // return view('admin.approval_request.approve')->with('diary',$diary_details);
    }
